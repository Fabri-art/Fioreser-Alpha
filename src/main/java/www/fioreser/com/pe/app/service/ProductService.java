...
public class ProductService {
    ...
    public ProductEntity getProductByIdPr(Integer idPr) {
      return productRepository.getProductByIdPr(idPr);
    }
    ...
    public ProductEntity saveProduct(ProductEntity productEntity,MultipartFile multipartFile) throws IOException {
        if (productEntity.getIdPr()== null) {
            ...
            ProductEntity productDB = productRepository.getProductByIdPr(productEntity.getIdPr());
    ...
    public boolean deleteProductByIdPr(Integer idPr) {
      return productRepository.deleteProductByIdPr(idPr);
    }
